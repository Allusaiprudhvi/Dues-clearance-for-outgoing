...
if (isset( $_POST['import']))
{
  ...
  if(in_array($_FILES["file"]["type"],$allowedFileType)){
       ...
       if(check_rollno($conn,$Reader,$sheetCount)){   
              ...
              if ((!empty($roll_no) || !empty($amount_paid))&&($roll_no!="Roll. No."))
                    {
                      ...
                      else
                      {
                          ...
                          $query = "insert into stu_dpt_dues(roll_no,dp_name,dues) values('$roll_no','$user_name' ,'$amount_paid')";
                        $result = $conn->query($query);
                         if($result==false)
                        die($conn->error);
                      }   
...
function check_rollno($conn,$Reader,$sheetCount)
{
			         ...
			         <div class="signin-form subscribe">	
						<h3>Upload Bank Bill</h3>
                                                <h4 style="color:white">Updated on : <?php echo $last_updated_date;?> </h4><br>
                                                                                                <h4 style="color:red"> <?php echo $msg;?> </h4><br>
